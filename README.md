...
- **Inspect an existing campaign URL** — paste a shipped description, bio, or ad link to refill the form and surface common shipping defects
...
- Inspected URLs are parsed only in the browser; `javascript:`, `data:`, `file:`, and doubled schemes are rejected
