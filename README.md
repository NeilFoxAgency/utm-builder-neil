...
- **Batch placements** — paste up to 40 placement IDs; one unique `utm_content` per asset; copy-all and batch CSV
...
5. Optional: open **Batch placements**, paste placement IDs (one per line), and generate a unique link per asset
