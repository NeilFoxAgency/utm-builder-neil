...
- **Batch placements** — paste up to 40 placement IDs; each becomes a unique `utm_content` while shared fields stay consistent
...
5. Optional: use **Batch placements** to paste many placement IDs (one per line) and generate unique links in one step; copy all or export a batch CSV
