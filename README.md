...
- **Batch placement IDs** — paste up to 40 placement IDs; shared UTM fields apply, each line becomes a unique `utm_content`
...
4. Optionally paste placement IDs (one per line) and use **Generate batch links**
5. Generate, copy, and (optionally) export history or batch as CSV
